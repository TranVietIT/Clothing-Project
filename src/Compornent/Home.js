                    ...
                    <div className="single-products">
                      ...
                      <div className="product-overlay">
                        <div className="overlay-content">
                          <h2>$60</h2>
                          <p>Easy Polo Black Edition</p>
                          <a id={1} href="#" className="btn btn-default add-to-cart"><i className="fa fa-shopping-cart" />Add to cart</a>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="single-products">
                      ...
                      <div className="product-overlay">
                        <div className="overlay-content">
                          <h2>$80</h2>
                          <p>Easy Polo Black Edition</p>
                          <a id={2} href="#" className="btn btn-default add-to-cart"><i className="fa fa-shopping-cart" />Add to cart</a>
                        </div>
                      </div>
                    </div>
                    <div className="choose">
                    ...
                    <div className="single-products">
                      ...
                      <div className="product-overlay">
                        <div className="overlay-content">
                          <h2>$100</h2>
                          <p>Easy Polo Black Edition</p>
                          <a id={3} href="#" className="btn btn-default add-to-cart"><i className="fa fa-shopping-cart" />Add to cart</a>
                        </div>
                      </div>
                    </div>
                    <div className="choose">
                    ...
                    <div className="single-products">
                      ...
                      <div className="product-overlay">
                        <div className="overlay-content">
                          <h2>$40</h2>
                          <p>Easy Polo Black Edition</p>
                          <a id={4} href="#" className="btn btn-default add-to-cart"><i className="fa fa-shopping-cart" />Add to cart</a>
                        </div>
                      </div>
                    ...
                    <div className="single-products">
                      ...
                      <div className="product-overlay">
                        <div className="overlay-content">
                          <h2>$75</h2>
                          <p>Easy Polo Black Edition</p>
                          <a id={5} href="#" className="btn btn-default add-to-cart"><i className="fa fa-shopping-cart" />Add to cart</a>
                        </div>
                      </div>
                    ...
                    <div className="single-products">
                      ...
                      <div className="product-overlay">
                        <div className="overlay-content">
                          <h2>$95</h2>
                          <p>Easy Polo Black Edition</p>
                          <a id={6} href="#" className="btn btn-default add-to-cart"><i className="fa fa-shopping-cart" />Add to cart</a>
                        </div>
                      </div>
                    </div>
                    <div className="choose">
